...
from entities import VariantThreeFcnDataset
...
BEST_MODEL_PATH = 'model/patch_variant_3_fcn.sav'
...
def do_train():
    ...
    training_set = VariantThreeFcnDataset(train_ids, id_to_label, id_to_url, EMBEDDINGS_DIRECTORY)
    val_set = VariantThreeFcnDataset(val_ids, id_to_label, id_to_url, EMBEDDINGS_DIRECTORY)
    test_java_set = VariantThreeFcnDataset(test_java_ids, id_to_label, id_to_url, EMBEDDINGS_DIRECTORY)
    test_python_set = VariantThreeFcnDataset(test_python_ids, id_to_label, id_to_url, EMBEDDINGS_DIRECTORY)
