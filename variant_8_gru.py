...
from model import VariantEightGruClassifier
...
BEST_MODEL_PATH = 'model/patch_variant_8_gru_model.sav'
CURRENT_MODEL_PATH = 'model/patch_variant_8_gru_current_model.sav'
